...
class CalendarScreen extends StatefulWidget {
  // CalendarScreen(String snap);
  final String current_user;
  final String current_user_id;

  // receive data from the FirstScreen as a parameter
  CalendarScreen(
      {Key? key, required this.current_user, required this.current_user_id})
      : super(key: key);
        ...
        child: Column(
          children: [
            Container(
              ...
              child: Text(
                "Attendance Details of ${widget.current_user_id}",
                style: TextStyle(
                  fontFamily: "NexaBold",
